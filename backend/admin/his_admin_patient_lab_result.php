                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Tambah Hasil Laboratorium</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Penyakit Pasien</th>
                                                <th data-hide="phone">Tanggal Uji Lab Dilakukan</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="his_admin_add_single_lab_result.php?lab_number=<?php echo $row->lab_number ;?>" class="badge badge-success"><i class="mdi mdi-flask"></i> Tambah Hasil Tes</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
