...
<head>
        <meta charset="utf-8" />
        <title>System Pengelolaan Data Rumah Sakit</title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/logoRS.png" alt="" height="80"></span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Masukkan alamat email dan kata sandi Anda untuk mengakses panel Manajer.</p>
                                </div>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" name="ad_email" type="email" id="emailaddress" required="" placeholder="Enter email manajer">
                                    </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p> <a href="his_admin_pwd_reset.php" class="text-black-50 ml-1">Forgot your password?</a></p>
                               <!-- <p class="text-white-50">Don't have an account? <a href="his_admin_register.php" class="text-white ml-1"><b>Sign Up</b></a></p>-->
                               <p class="text-black-50">Back to home <a href="../../index.php" class="text-blue ml-1"><b>Home</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
