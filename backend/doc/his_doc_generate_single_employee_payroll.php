                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="clearfix">
                                            <div class="float-left">
                                                <img src="assets/images/logoRS.png" alt="" height="100">
                                            </div>
                                            <div class="float-right">
                                                <h4 class="m-0 d-print-none"><?php echo $row->pay_pat_number;?></h4>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 offset-md-2">
                                                <div class="mt-3 float-right">
                                                    ...
                                                    <p class="m-b-10"><strong>Bill Status : </strong> <span class="float-right"><span class="badge badge-success"><?php echo $row->pay_status;?></span></span></p>
                                                    <p class="m-b-10"><strong>Bill Number. : </strong> <span class="float-right"><?php echo $row->pay_number;?></span></p>
                                                    <p class="m-b-10"><strong>Pasiem Nomber. : </strong> <span class="float-right"><?php echo $row->pay_pat_number;?></span></p>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        ...
                                                        <tr><th>#</th>
                                                            ...
                                                            <th style="width: 10%">TAX Percen (%)</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    $pat_number = $_GET['pay_pat_number'];
                                                                    ...
                                                                    while($row=$res->fetch_object())
                                                                    { ?>
                                                                    <b><?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?></b> <br/>
                                                                    <?php }?>
...
<!--             
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Sub-total:</b> <span class="float-right">$ <?php echo $row->pay_bill;?></span></p>
                                                    <p><b>PAYE Bill (16%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; <?php echo $taxable_salary;?> </span></p>
