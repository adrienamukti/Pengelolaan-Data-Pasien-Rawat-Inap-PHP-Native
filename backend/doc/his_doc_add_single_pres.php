                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputEmail4" class="col-form-label">Nomor Pasien</label>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Tipe Pasien</label>
                                                ...
                                                <div class="form-group ">
                                                        <label for="inputCity" class="col-form-label">Nama Penyakit</label>
                                                ...
                                                <button type="submit" name="add_patient_presc" class="ladda-button btn btn-primary" data-style="expand-right">Add Resep Obat</button>
