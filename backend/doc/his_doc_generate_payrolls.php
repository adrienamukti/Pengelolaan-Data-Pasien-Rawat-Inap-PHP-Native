                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Generate Pembayaran</li>
                                        </ol>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-toggle="true">Pasien Nomor</th>
                                                <th data-hide="phone">Nomor Tagihan</th>
                                                <th data-hide="phone">Tagihan</th>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td><?php echo $cnt;?></td>
                                                    <td><?php echo $row->pay_pat_name;?></td>
                                                    <td><?php echo $row->pay_pat_number;?></td>
                                                    ...
                                                    <td>
                                                       <!-- <a href="his_admin_manage_payrolls.php?delete_pay_number=<?php echo $row->pay_number;?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a> -->
                                                        <a href="his_doc_generate_single_employee_payroll.php?pay_number=<?php echo $row->pay_number;?>&&pay_pat_number=<?php echo $row->pay_pat_number;?>" class="badge badge-success"><i class="fas fa-file-invoice-dollar "></i> Generate Bill</a>
