...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_payroll']))
		{
            ...
            // $pay_pat_email = $_POST['pay_pat_email'];
            $pay_emp_salary = $_POST['pay_bill'];
            $pay_descr = $_POST['pay_descr'];
            //$mdr_pat_ailment = $_POST['mdr_pat_ailment'];
            //sql to insert captured values
			$query = "INSERT INTO his_payrolls (pay_number, pay_pat_name, pay_pat_number, pay_bill, pay_descr) VALUES (?, ?, ?, ?, ?)";
            $stmt = $mysqli->prepare($query);
            $rc = $stmt->bind_param('sssss', $pay_number, $pay_pat_name, $pay_pat_number, $pay_emp_salary, $pay_descr);
            $stmt->execute();
                                            ...
                                            <form method="post">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" required="required" readonly name="pay_pat_name" value="<?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?>" class="form-control" id="inputEmail4" placeholder="Patient's Name">
                                                    </div>

                                                    <!-- <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Employee Email</label>
                                                        <input required="required" type="text" readonly name="pay_pat_email" value="<?php echo $row->pat_email;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div> -->

                                                    <div class="form-group col-md-4">
                                                        <label for="inputPassword4" class="col-form-label">Employee Number</label>
                                                        <input required="required" type="text" readonly name="pay_pat_number" value="<?php echo $row->pat_number;?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                                                    </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" required="required"  name="pay_bill"  class="form-control" id="inputEmail4" >
                                                    </div>
