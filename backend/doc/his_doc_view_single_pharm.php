                                ...
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            ...
                                            <li class="breadcrumb-item active">Detail Farmasi</li>
                                            </ol>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3">Nama Farmasi : <?php echo $row->phar_name;?></h2>
                                                    <hr>
                                                    <h4 class="text-danger">VendorFarmasi : <?php echo $row->phar_vendor;?></h4>
                                                    <hr>
                                                    <h4 class="text-danger">Kuantitas Farmasi : <?php echo $row->phar_qty;?> Cartons</h4>
                                                    <hr>
                                                    <h4 class="text-danger">Deskrisi Farmasi : </h4>
