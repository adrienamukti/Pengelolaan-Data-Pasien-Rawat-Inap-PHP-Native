...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Add Detail Pasien</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" required="required" name="pat_dob" class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY" pattern="\d{2}/\d{2}/\d{4}" oninput="this.value = this.value.replace(/[^0-9/]/g, '');">
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Nomor Telepon</label>
                                                    <input required="required" type="number" name="pat_phone" class="form-control" id="inputCity">
                                                </div>
                                                <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputState" class="col-form-label">Type Pasien</label>
                                                ...
                                                <div class="form-group col-md-2" style="display:none">
                                                    ...
                                                    ?>
                                                    <label for="inputZip" class="col-form-label">Nomor Pasien</label>
                                                    <input type="text" name="pat_number" value="<?php echo $patient_number;?>" class="form-control" id="inputZip">
                                                </div>
                                            </div>

                                            <button type="submit" name="add_patient" class="ladda-button btn btn-primary" data-style="expand-right">Add Pasien</button>
    ...
    document.getElementById('inputEmail4').addEventListener('input', function() {
        ...
        if (this.value.length === 10 && !pattern.test(this.value)) {
            alert('Format tidak sesuai. Harap gunakan format DD/MM/YYYY.');
