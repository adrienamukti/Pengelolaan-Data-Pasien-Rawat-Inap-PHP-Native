                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="his_admin_logout.php">
                                        <span><img src="assets/images/logoRS.png" alt="" height="60"></span>
                                    </a>
                                </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="text-muted font-13"> Anda sekarang berhasil keluar. </p>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Kembali Ke <a href="index.php" class="text-white ml-1"><b>Log In</b></a> ATAU <a href="../../index.php" class="text-white ml-1"><b>Beranda</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
