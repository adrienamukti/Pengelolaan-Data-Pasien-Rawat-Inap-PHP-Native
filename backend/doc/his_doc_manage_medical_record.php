                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Riwayat Medis</a></li>
                                            <li class="breadcrumb-item active">Kelola Riwayat Medis</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Kelola Riwayat Medis</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                ...
                                                <th data-hide="phone">Nomor Pasien</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->mdr_pat_age;?> Tahun</td>
                                                    <td>
                                                        <a href="his_doc_view_single_medical_record.php?mdr_id=<?php echo $row->mdr_id;?>&&mdr_number=<?php echo $row->mdr_number;?>" class="badge badge-success"><i class="fas fa-eye"></i> View</a>
                                                        <a href="his_doc_upate_single_medical_record.php?mdr_number=<?php echo $row->mdr_number;?>" class="badge badge-warning"><i class="fas fa-eye-dropper "></i> Update</a>
