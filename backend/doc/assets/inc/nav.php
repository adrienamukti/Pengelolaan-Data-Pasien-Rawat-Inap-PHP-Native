<?php
    ...
    {
?>
    <div class="navbar-custom" style="background-color: #264653;">
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    <img src="assets/images/logoRS.png" alt="" height="60"><span style="font-size: 20px; color:white;">Hospital</span>
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-sm">
                    <!-- <span class="logo-sm-text-dark">U</span> -->
                    <img src="assets/images/logoRS.png" alt="" height="45">
                </span>
            </a>
        </div>
