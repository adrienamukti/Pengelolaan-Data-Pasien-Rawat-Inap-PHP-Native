                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Catatan Farmasi</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Farmasi</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <tr>
                                                <th>#</th>
                                                <th data-toggle="true">Nama Farmasi</th>
                                                <th data-hide="phone">Barcode Farmasi</th>
                                                <th data-hide="phone">Penjual Farmasi</th>
                                                <th data-hide="phone">Kategori Farmasi</th>
                                                <th data-hide="phone">Kuantitas Farmasi</th>
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->phar_qty;?> Karton</td>
