                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Catatan Medis</a></li>
                                                <li class="breadcrumb-item active">Tambah Catatan Medis</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Tambah Catatan Medis</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                            ...
                                            <form method="post">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputEmail4" class="col-form-label">Nomber Pasien</label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="inputPassword4" class="col-form-label">Penyakit Pasein</label>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-2" style="display:none">
                                                        ...
                                                        ?>
                                                        <label for="inputZip" class="col-form-label">Nomber Catatn Medis</label>
                                                ...
                                                <div class="form-group">
                                                        <label for="inputAddress" class="col-form-label">Resep Pasien</label>
                                                        <textarea required="required"  type="text" class="form-control" name="mdr_pat_prescr" id="editor"><?php echo $row->pres_ins;?> </textarea>
                                                </div>
                                                <?php }?>

                                                <button type="submit" name="add_patient_mdr" class="ladda-button btn btn-primary" data-style="expand-right">Tambah Catatan Medis Pasien</button>
